...
def organize_files():
    ...
    mp_three_folder = input("What location do you want your MP3 files to be in: ").strip()
    mp_four_folder = input("What location do you want your MP4 files to be in: ").strip()
